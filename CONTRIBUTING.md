...
- Make a copy of the mod descriptor file (`mod/Russia-2.0/descriptor.mod`) into your mod folder (`Documents\Paradox Interactive\Hearts of Iron IV\mod`),
- Its content should be left as is with an added `path` line at the end, which should be the full absolute path to the mod's folder, e.g. `path="C:/Users/YourName/Documents/Paradox Interactive/Hearts of Iron IV/mod/Russia 2.0"`,
...
- Name : Russia 2.0,
- Version : The current version of the mod in the `descriptor.mod` file (e.g. 3.0.4),
